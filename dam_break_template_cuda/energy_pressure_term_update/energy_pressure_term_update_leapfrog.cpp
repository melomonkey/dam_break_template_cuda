...
void energy_pressure_term_update_leapfrog_schm1a(vector<vector<int>> neighbors_list, vector<PARTICLE> * particles, double dt)
{
	for(int i = 0; i < neighbors_list.size(); ++ i)
	{
		...
		(*particles)[calcu_particle].energy.val[2] = energy_deriv; 
...
void energy_pressure_term_update_leapfrog_schm1b(vector<vector<int>> neighbors_list, vector<PARTICLE> * particles, double dt)
{
	for(int i = 0; i < neighbors_list.size(); ++ i)
	{
		int calcu_particle = neighbors_list[i][0];			
		...
		double tmp = (*particles)[calcu_particle].energy.val[2] * dt; 
		(*particles)[calcu_particle].energy.val[2] = (*particles)[calcu_particle].energy.val[1]; 
		(*particles)[calcu_particle].energy.val[1] = (*particles)[calcu_particle].energy.val[0];
		(*particles)[calcu_particle].energy.val[0] += tmp * dt;
	}

}


void energy_pressure_term_update_leapfrog_schm2a(vector<vector<int>> neighbors_list, vector<PARTICLE> * particles, double dt)
{
	for(int i = 0; i < neighbors_list.size(); ++ i)
	{
		int calcu_particle = neighbors_list[i][0];
...
void energy_pressure_term_update_leapfrog_schm2b(vector<vector<int>> neighbors_list, vector<PARTICLE> * particles, double dt)
{
	for(int i = 0; i < neighbors_list.size(); ++ i)
	{
		int calcu_particle = neighbors_list[i][0];			
